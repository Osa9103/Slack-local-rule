...
## 目的
本Slackワークスペース（以下、ワークスペース）の利用は、若手研究者間における以下の情報共有、ならびにコミュニケーションの促進を目的とします。
- 研究・実験についての相談
...
3.	特定のメンバーへのコメント（メンション）はいつでもOKです。受信通知は各自で設定してください（設定例を[こちら](https://github.com/Osa9103/Slack-local-rule/blob/main/guide-to-Slack-notifications.md)に記載します）。
